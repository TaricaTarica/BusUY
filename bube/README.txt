...
a persistence unit "bubePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "bube\pom.xml":
...
artifacts ("bube-ejb.jar" and "bube-web.war") are already built. You can build
