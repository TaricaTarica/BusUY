 ...
 */
@WebServlet("/BorrarLineaDeParada")
public class BorrarLineaDeParada extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean res=clpr.borrarLineaParada(idparada, idlinea);
